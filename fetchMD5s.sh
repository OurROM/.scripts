...
#mv ~/aokp_jb/.scripts/MAKOmd5s.txt ~/Desktop/Latest_Builds/mako/
#mv ~/aokp_jb/.scripts/GROUPERmd5s.txt ~/Desktop/Latest_Builds/grouper/
#mv ~/aokp_jb/.scripts/TILAPIAmd5s.txt ~/Desktop/Latest_Builds/tilapia/
#mv ~/aokp_jb/.scripts/TOROmd5s.txt ~/Desktop/Latest_Builds/toro/
...
mv ~/aokp_jb/.scripts/MANTAmd5s.txt ~/Desktop/Latest_Builds/manta/$mmd5.md5
wait
