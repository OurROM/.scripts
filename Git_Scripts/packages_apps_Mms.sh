...
clear
                               # * Change if Required
echo "What would you like to do with packages_apps_Mms?"
...
case $choice in
     ...
     clear
                                    # * Change if Required
     git push git@github.com:OurROM/packages_apps_Mms.git HEAD:jb-mr1
     wait
     echo ""
     ...
     wait
     echo ""
     echo "packages_apps_Mms has been RESET"
     echo ""
     read -p "Press [Enter] key to continue..."
     ;;
     6)
